...
| browsers/cypress-chrome:cypress-9.2.1 | browsers/cypress-chrome:97.0 | 9.2.1 | 97.0.4692.71
|===
...
| browsers/cypress-edge:cypress-9.2.1 | browsers/cypress-edge:97.0 | 9.2.1 | 97.0.1072.55
|===
